...
var RTCMultiConnection = function(roomid, forceOptions) {
    ...
    (function(connection) {
        ...
        connection.userid = getRandomString();		//*** 여기가 맞는거 같은데.. userid를 여러곳에서 key 로 쓰고 있어서... 일단 후퇴 2018.12.16
        ...
        connection.setCustomSocketEvent = function(customEvent) {
            if (customEvent) {
                ...
                console.log("6 : " + customEvent);
                console.log("7 : " + connection.socketCustomEvent);
                console.log("8 : " + connection.socketCustomEvent.test);
            }
        ...
        connection.socketCustomEvent = function() {
            connection.socket.emit('custom-message', connection.socketCustomEvent);			//***
        };
